...
import { HoursMinutes, formatHoursMinutes, normalizeTime, roundTime, sortTimeFunction } from '@/lib/draft/utils'
...
export function TimeSelectionModal({ isOpen, onClose, onSelectTime, position, clickedTime, roundMinutes }: TimeSelectionModalProps) {
  const time = roundTime(clickedTime ?? {
    hours: 12,
    minutes: 0,
  }, roundMinutes)
