...
export default function SchedulePlanner(props: {
  ...
  const [selectedDurationMinute, setSelectedDurationMinute] =
    useState<number>(60);
  const [excludePeriod, setExcludePeriod] = useState<ExcludePeriod>({
    start: 22,
    end: 8,
  });
    ...
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <SelectDuration
            defaultValue={60}
            dispatch={setSelectedDurationMinute}
          />
        </div>
        <div className="">
      ...
      <div className="flex row items-center">
        ...
        <div className="w-20">
          <Select
            ...
            onValueChange={(start) =>
              onChange(start, defaultValue.end.toString())
            }
          >
            <SelectTrigger>
        ...
        <div className="w-20">
          <Select
            ...
            onValueChange={(end) =>
              onChange(defaultValue.start.toString(), end)
            }
          >
            <SelectTrigger>
